package com.hong.forapw.integration.oauth.model;
...
public class KakaoOauthDTO {
    ...
    public record Account(String email, Boolean profile_nickname_needs_agreement, Boolean profile_image_needs_agreement,
                          Profile profile) {
    }
